...
/**
 * DTO: Represents one day's booking summary for calendar view.
 * Used by /api/seminars/calendar endpoint.
 */
public class CalendarDaySummary {
    ...
    private boolean free;      // true = no bookings on that day
    private int bookingCount;  // number of bookings affecting this date
